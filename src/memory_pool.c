...
umf_result_t umfPoolCreateEx(const umf_memory_pool_ops_t *ops,
                             umf_memory_provider_handle_t provider,
                             void *params, umf_pool_create_flags_t flags,
                             umf_memory_pool_handle_t *hPool) {
    umf_result_t ret = umfPoolCreate(ops, provider, params, hPool);
