...
TEST_F(test, metadataUseProvider) {
    ...
    try {
        poolMetadataByMalloc = poolCreateExt<ErrorReportingStrategyType::Exception>({&UMF_JEMALLOC_POOL_OPS, (void*)&metadataByMallocParams, &provider_ops, nullptr});
    ...
    auto poolMetadataByProvider = poolCreateExt({&UMF_JEMALLOC_POOL_OPS, (void*)&metadataByProviderParams, &provider_ops, nullptr});
